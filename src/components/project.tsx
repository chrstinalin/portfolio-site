...
const Project = (props: { banner: any, logo: any; title: any; description: any; linkText: any; link: any; isFirst: boolean}) => {
	...
	return (
		<React.Fragment>
			<div className={`${isFirst? "w-full h-96" : "w-96 h-80"} overflow-hidden rounded-lg border-b border-gray-300 bg-gradient-to-b from-zinc-200 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-900 dark:from-inherit`}>
