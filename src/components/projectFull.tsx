...
const ProjectFull = (props: { banner: any, logo: any; title: any; description: any; linkText: any; link: any }) => {
    ...
    return (
        <React.Fragment>
            <div onClick={(e) => {e.stopPropagation()}} className={"overflow-hidden h-full w-full bg-white z-50 rounded-lg border-b border-gray-300 bg-gradient-to-b from-zinc-200  dark:border-neutral-800 dark:bg-zinc-900 dark:from-inherit"}>
