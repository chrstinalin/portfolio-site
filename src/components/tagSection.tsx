...
export const TagSection = (props: { title: any; tags: any; Icon: any}) => {
    ...
    return (
        <React.Fragment>
            <div className={"rounded-lg p-6 w-56 h-44 flex flex-col items-center gap-2 border-b border-gray-300 bg-gradient-to-b from-zinc-200 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-900 dark:from-inherit"}>
